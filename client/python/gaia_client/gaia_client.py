...
import gaia_client.gpio_control as gpio_control
...
class GaiaClient:
    ...
    def __init__(self):
        ...
        self.gpio = gpio_control.GPIOControl()
        if self.gpio == None:
            print("GPIO not initialized, quitting")
            sys.exit(1)

        self.fishCron = Cron("igor", IGOR_CRON)
    ...
    print "[GaiaClient] db and gpio initialized"
